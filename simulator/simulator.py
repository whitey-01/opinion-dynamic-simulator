...
#save as xml the results of multiple simulation on the same configuration
def saveMultipleSimulationsData(directory: str, simulations: list):
    simulations_tag = "<simulations>\n"
    for simulation in simulations:
        simulation: sr.SimulationResult = simulation
        simulation_tag = "    <simulation-" + simulation.simulation_id + ">" + str(simulation.rounds) + "</simulation-" + simulation.simulation_id + ">\n"
        simulations_tag += simulation_tag
    simulations_tag += "/<simulations>"
