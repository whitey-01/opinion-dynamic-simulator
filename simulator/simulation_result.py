...
class SimulationResult:
    ...
    def saveConfigurationDataAsXML(self, simulation_id_path = ""):
        config = "<config>\n"
        comment = "    <config-comment>" + self.simulation_configurator.comment + "</config-comment>\n"
        updateRule = "    <config-update-rule>" + self.simulation_configurator.opinion_update_rule.value + "</config-update-rule>\n"
        bias = "    <config-bias>" + str(self.simulation_configurator.bias) + "</config-bias>\n"
        config = config + comment + updateRule + bias + "</config>"
    ...
    def saveSimulationOutputAsXML(self, simulation_id_path):
        ...
        simulation = simulation + rounds + "</simulation>"
